...
<div class="container-fluid p-3 bg-light">
	<div class="row">
		<div class="col-md-3 text-success">
			<h3>
				<i class="fa-sharp fa-solid fa-book"></i> BookBuddies
			</h3>
		</div>
		<div class="col-md-6">
		...
		<c:if test="${not empty userobj }">
			...
			<div class="col-md-3">
				<a href="checkout.jsp" class="btn btn-primary"><i class="fas fa-cart-plus "></i> Cart</a> <a
					href="" class="btn btn-success"><i class="fas fa-user"></i>
